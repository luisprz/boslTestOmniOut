...
const express = require('express'),
    ...
    defaultBuilder = require('@omnistudio/resources/src/javascript/utils/webpackBuilder'),
...
const npmBasePath = path.resolve(__dirname, '../node_modules/@omnistudio');
