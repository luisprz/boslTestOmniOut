 ...
 */
import VlocApp from 'vlocityomniscript/leadPersonalLoanEnglish';
...
if (isCompatibleBrowser) {
     ...
     */
    if (!customElements.get('vlocityomniscript-sample-off-platform-english')) {
        customElements.define('vlocityomniscript-sample-off-platform-english', VlocApp.CustomElementConstructor);
    }
}
