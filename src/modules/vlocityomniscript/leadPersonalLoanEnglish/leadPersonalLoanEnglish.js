...
import { OMNIDEF } from './leadPersonalLoanEnglish_def.js';
import tmpl from './leadPersonalLoanEnglish.html';
import tmpl_nds from './leadPersonalLoanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class leadPersonalLoanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
